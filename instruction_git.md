...
Ветки в git используются для совместной работы над проектом.
...
Для слияния используется команда 

     git merge

Для слияния нужно находиться в той ветке куда будем вливать изменения
